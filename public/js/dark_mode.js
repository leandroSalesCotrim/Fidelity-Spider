                    ...
                    if (typeof img5 != "undefined") {
                        if (typeof img6 != "undefined") {
                            if (typeof img7 != "undefined") {
                                img1.style.borderColor = "#6B0D10";
                                img1.style.borderColor = "#6B0D10";
                                img2.style.borderColor = "#6B0D10";
                                img2.style.borderColor = "#6B0D10";
                                img3.style.borderColor = "#6B0D10";
                                img3.style.borderColor = "#6B0D10";
                                img4.style.borderColor = "#6B0D10";
                                img4.style.borderColor = "#6B0D10";
                                img5.style.borderColor = "#6B0D10";
                                img5.style.borderColor = "#6B0D10";
                                img6.style.borderColor = "#6B0D10";
                                img6.style.borderColor = "#6B0D10";
                                img7.style.borderColor = "#6B0D10";
                                img7.style.borderColor = "#6B0D10";
                            }
                        }
                    }
            ...
            if (typeof img3 != "undefined") {
                if (typeof img4 != "undefined") {
                    if (typeof img5 != "undefined") {
                        if (typeof img6 != "undefined") {
                            if (typeof img7 != "undefined") {
                                img1.style.borderColor = "#151515";
                                img1.style.borderColor = "#151515";
                                img2.style.borderColor = "#151515";
                                img2.style.borderColor = "#151515";
                                img3.style.borderColor = "#151515";
                                img3.style.borderColor = "#151515";
                                img4.style.borderColor = "#151515";
                                img4.style.borderColor = "#151515";
                                img5.style.borderColor = "#151515";
                                img5.style.borderColor = "#151515";
                                img6.style.borderColor = "#151515";
                                img6.style.borderColor = "#151515";
                                img7.style.borderColor = "#151515";
                                img7.style.borderColor = "#151515";
                            }
                        }
                    }
